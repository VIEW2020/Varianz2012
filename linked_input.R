...
# Sabastiano / Suneela VARIANZ 2012 Population v1
...
fst::write.fst(Baseline_FINAL, "sbar288/working/R_VARIANZ_2012_v1.fst", compress = 75)
haven::write_dta(Baseline_FINAL, "sbar288/working/Stata14_VARIANZ_2012_v1.dta", version = 14)
feather::write_feather(Baseline_FINAL, "sbar288/working/Py_VARIANZ_2012_v1.feather")
