...
def main():
    # Load data
    df = feather.read_dataframe(hp.data_dir + 'Py_VARIANZ_2012_v1.feather')
    
    # Exclude
    df = df[~df['ph_loopdiur_prior_5yrs_3evts'].astype(bool)]
    ...
    df.to_feather(hp.data_pp_dir + 'Py_VARIANZ_2012_v1_pp.feather')
