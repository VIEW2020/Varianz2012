...
def main():
    ...
    print('Men: {} ({:.1}%)'.format(num_males, num_males/num_participants))
    print('Women: {} ({:.1}%)'.format(num_females, num_females/num_participants))
    mean_age_males, var_age_males = df.loc[df['gender_code'], 'nhi_age'].mean(), df.loc[df['gender_code'], 'nhi_age'].std()
    mean_age_females, var_age_females = df.loc[~df['gender_code'], 'nhi_age'].mean(), df.loc[~df['gender_code'], 'nhi_age'].std()
    print('Age Men: {:.1} ({:.1}%)'.format(mean_age_males, var_age_males))
    print('Age Women: {:.1} ({:.1}%)'.format(mean_age_females, var_age_females))
    num_nze_males = (df.loc[df['gender_code'], 'en_prtsd_eth'] == 1).sum()
    num_nze_females = (df.loc[~df['gender_code'], 'en_prtsd_eth'] == 1).sum()
    print('NZE Men: {} ({:.1}%)'.format(num_nze_males, num_nze_males/num_males))
    print('NZE Women: {} ({:.1}%)'.format(num_nze_females, num_nze_females/num_females))
    num_maori_males = (df.loc[df['gender_code'], 'en_prtsd_eth'] == 2).sum()
    num_maori_females = (df.loc[~df['gender_code'], 'en_prtsd_eth'] == 2).sum()
    print('Maori Men: {} ({:.1}%)'.format(num_maori_males, num_maori_males/num_males))
    print('Maori Women: {} ({:.1}%)'.format(num_maori_females, num_maori_females/num_females))
    num_pacific_males = (df.loc[df['gender_code'], 'en_prtsd_eth'] == 3).sum()
    num_pacific_females = (df.loc[~df['gender_code'], 'en_prtsd_eth'] == 3).sum()
    print('Pacific Men: {} ({:.1}%)'.format(num_pacific_males, num_pacific_males/num_males))
    print('Pacific Women: {} ({:.1}%)'.format(num_pacific_females, num_pacific_females/num_females))
    num_indian_males = (df.loc[df['gender_code'], 'en_prtsd_eth'] == 43).sum()
    num_indian_females = (df.loc[~df['gender_code'], 'en_prtsd_eth'] == 43).sum()
    print('Indian Men: {} ({:.1}%)'.format(num_indian_males, num_indian_males/num_males))
    print('Indian Women: {} ({:.1}%)'.format(num_indian_females, num_indian_females/num_females))
    num_other_males = num_males - num_nze_males - num_maori_males - num_pacific_males - num_indian_males
    num_other_females = num_females - num_nze_females - num_maori_females - num_pacific_females - num_indian_females
    print('Other Men: {} ({:.1}%)'.format(num_other_males, num_other_males/num_males))
    print('Other Women: {} ({:.1}%)'.format(num_other_females, num_other_females/num_females))
    num_dp1_males = (df.loc[df['gender_code'], 'en_nzdep_q'] == 1).sum()
    num_dp1_females = (df.loc[~df['gender_code'], 'en_nzdep_q'] == 1).sum()
    print('dp1 Men: {} ({:.1}%)'.format(num_dp1_males, num_dp1_males/num_males))
    print('dp1 Women: {} ({:.1}%)'.format(num_dp1_females, num_dp1_females/num_females))
    num_dp2_males = (df.loc[df['gender_code'], 'en_nzdep_q'] == 2).sum()
    num_dp2_females = (df.loc[~df['gender_code'], 'en_nzdep_q'] == 2).sum()
    print('dp2 Men: {} ({:.2}%)'.format(num_dp2_males, num_dp2_males/num_males))
    print('dp2 Women: {} ({:.2}%)'.format(num_dp2_females, num_dp2_females/num_females))
    num_dp3_males = (df.loc[df['gender_code'], 'en_nzdep_q'] == 3).sum()
    num_dp3_females = (df.loc[~df['gender_code'], 'en_nzdep_q'] == 3).sum()
    print('dp3 Men: {} ({:.3}%)'.format(num_dp3_males, num_dp3_males/num_males))
    print('dp3 Women: {} ({:.3}%)'.format(num_dp3_females, num_dp3_females/num_females))
    num_dp4_males = (df.loc[df['gender_code'], 'en_nzdep_q'] == 4).sum()
    num_dp4_females = (df.loc[~df['gender_code'], 'en_nzdep_q'] == 4).sum()
    print('dp4 Men: {} ({:.4}%)'.format(num_dp4_males, num_dp4_males/num_males))
    print('dp4 Women: {} ({:.4}%)'.format(num_dp4_females, num_dp4_females/num_females))
    num_dp5_males = (df.loc[df['gender_code'], 'en_nzdep_q'] == 5).sum()
    num_dp5_females = (df.loc[~df['gender_code'], 'en_nzdep_q'] == 5).sum()
    print('dp5 Men: {} ({:.5}%)'.format(num_dp5_males, num_dp5_males/num_males))
    print('dp5 Women: {} ({:.5}%)'.format(num_dp5_females, num_dp5_females/num_females))
    ...
    print('Diabetes Men: {} ({:.1}%)'.format(num_diabetes_males, num_diabetes_males/num_males))
    print('Diabetes Women: {} ({:.1}%)'.format(num_diabetes_females, num_diabetes_females/num_females))    
    num_AF_males = df.loc[df['gender_code'], 'hx_af'].sum()
    num_AF_females = df.loc[~df['gender_code'], 'hx_af'].sum()
    print('AF Men: {} ({:.1}%)'.format(num_AF_males, num_AF_males/num_males))
    print('AF Women: {} ({:.1}%)'.format(num_AF_females, num_AF_females/num_females))    
    ...
    print('BP Men: {} ({:.1}%)'.format(num_BP_males, num_BP_males/num_males))
    print('BP Women: {} ({:.1}%)'.format(num_BP_females, num_BP_females/num_females))    
    ...
    print('LL Men: {} ({:.1}%)'.format(num_LL_males, num_LL_males/num_males))
    print('LL Women: {} ({:.1}%)'.format(num_LL_females, num_LL_females/num_females))    
    ...
    print('APAC Men: {} ({:.1}%)'.format(num_APAC_males, num_APAC_males/num_males))
    print('APAC Women: {} ({:.1}%)'.format(num_APAC_females, num_APAC_females/num_females))    
    follow_up_males = df.loc[df['gender_code'], 'TIME'].sum()
    follow_up_females = df.loc[~df['gender_code'], 'TIME'].sum()
    bp()
    print('Follow up Men: {} ({:.1})'.format(follow_up_males, 99))
    print('Follow up Women: {} ({:.1})'.format(follow_up_females, 99))    
    num_CVD_death_males = df.loc[df['gender_code'], 'imp_fatal_cvd'].sum()
    num_CVD_death_females = df.loc[~df['gender_code'], 'imp_fatal_cvd'].sum()
    print('CVD death Men: {} ({:.1}%)'.format(num_CVD_death_males, num_CVD_death_males/num_males))
    print('CVD death Women: {} ({:.1}%)'.format(num_CVD_death_females, num_CVD_death_females/num_females))    
    num_CVD_event_males = df.loc[df['gender_code'], 'EVENT'].sum()
    num_CVD_event_females = df.loc[~df['gender_code'], 'EVENT'].sum()
    print('CVD event Men: {} ({:.1}%)'.format(num_CVD_event_males, num_CVD_event_males/num_males))
    print('CVD event Women: {} ({:.1}%)'.format(num_CVD_event_females, num_CVD_event_females/num_females))
    tmp_males = df.loc[df['gender_code'] & df['EVENT'], 'TIME']
    ...
    tmp_females = df.loc[~df['gender_code'] & df['EVENT'], 'TIME']
    ...
    print('Time to CVD Men: {:.1} ({:.1}, {:.1})'.format(time_to_CVD_males, time_to_CVD_males_Q1, time_to_CVD_males_Q3))
    print('Time to CVD Women: {:.1} ({:.1}, {:.1})'.format(time_to_CVD_females, time_to_CVD_females_Q1, time_to_CVD_females_Q3))
